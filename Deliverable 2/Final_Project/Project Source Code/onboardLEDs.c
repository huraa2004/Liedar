...
void SetMeasurementLED(void) {
    GPIO_PORTN_DATA_R |= 0x01;  // Set PN0 high
}

void ResetMeasurementLED(void) {
    GPIO_PORTN_DATA_R &= ~0x01; // Set PN0 low
}

void SetUARTLED(void) {
    GPIO_PORTN_DATA_R |= 0x02;  // Set PN1 high
}

void ResetUARTLED(void) {
    GPIO_PORTN_DATA_R &= ~0x02; // Set PN1 low
}
...
// AH - Toggle functions for blinking effects
void ToggleMeasurementLED(void) {
    GPIO_PORTN_DATA_R ^= 0x01;  // Toggle PN0
}
...
void TogglePLLLED(void) {
	GPIO_PORTF_DATA_R ^= 0x01;  // Toggle PF0
}
//Flash D1
